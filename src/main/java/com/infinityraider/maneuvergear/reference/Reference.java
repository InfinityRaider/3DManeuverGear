...
public final class Reference {
    ...
    public static final String VER_MINOR = /*^${mod.version_minor}^*/ "0";
    public static final String VER_PATCH = /*^${mod.version_patch}^*/ "2";
    public static final String MOD_VERSION = /*^${mod.version}^*/ VER_MAJOR + "." + VER_MINOR + "." + VER_PATCH;
    public static final String VERSION = /*^${mod.version_minecraft}-${mod.version}^*/ "1.16.4-" + MOD_VERSION;

    public static final String UPDATE_URL = /*^${mod.update_url}^*/ "https://www.youtube.com/watch?v=dQw4w9WgXcQ";
}
